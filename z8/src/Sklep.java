...
public class Sklep implements SklepInterfejs {
    ...
    public void dodajProdukt(Produkt p)
    {
        ...
        {
            this.produkty.add(p);
            System.out.println("Dodano produkt " + p.getNazwa() + " do sklepu.");
        }
        else System.out.println("Produkt " + p.getNazwa() + " już znajduje się w sklepie.");
    }
    ...
    public Produkt wyszukajProdukt(String s)
    {
        ...
        {
            if(Objects.equals(p.getNazwa(), s)) return p;
        }
        return null;
    }
